...
// INITIALISE ----------------------------------------------------------------
// This function gets everything ready by retrieving the data from the JSON files,
// and setting up the search and the player modal
function init() {
  // Send an AJAX request to fetch a JSON file and pass it as an object (data) to a function.
  // The function then gets the array of video objects from the object and stores it in a global varaible.
  $.getJSON('json/videos.json', function (data) {
    // Get the data into the global scope
  ...
  // Send an AJAX request to fetch a JSON file and pass it as an object (data) to a function.
  // The function then gets the array of category objects from the object and stores it in a global varaible.
...
function displayVideos(videos) { // Takes an array of videos and calls it 'videos'
...
function initPlayer() {
  ...
  $('#player').click(function () { // On click,
